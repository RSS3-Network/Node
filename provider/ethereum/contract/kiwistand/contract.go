...
//go:generate go run -mod=mod github.com/ethereum/go-ethereum/cmd/abigen --abi abi/kiwi.abi --pkg kiwistand --type ProtocolRewards --out contract_kiwi.go
// ProtocolRewards
// https://optimistic.etherscan.io/address/0x7777777f279eba3d3ad8f4e708545291a6fdba8b
//go:generate go run -mod=mod github.com/ethereum/go-ethereum/cmd/abigen --abi abi/ProtocolRewards.abi --pkg kiwistand --type Kiwi --out contract_protocol_rewards.go
