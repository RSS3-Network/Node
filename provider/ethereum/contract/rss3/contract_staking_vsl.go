...
func (_StakingVSL *StakingVSLTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _StakingVSL.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_StakingVSL *StakingVSLSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _StakingVSL.Contract.Fallback(&_StakingVSL.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_StakingVSL *StakingVSLTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _StakingVSL.Contract.Fallback(&_StakingVSL.TransactOpts, calldata)
}
...
func (_StakingVSL *StakingVSLTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _StakingVSL.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_StakingVSL *StakingVSLSession) Receive() (*types.Transaction, error) {
	return _StakingVSL.Contract.Receive(&_StakingVSL.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_StakingVSL *StakingVSLTransactorSession) Receive() (*types.Transaction, error) {
	return _StakingVSL.Contract.Receive(&_StakingVSL.TransactOpts)
}

// StakingVSLAdminChangedIterator is returned from FilterAdminChanged and is used to iterate over the raw logs and unpacked data for AdminChanged events raised by the StakingVSL contract.
type StakingVSLAdminChangedIterator struct {
	Event *StakingVSLAdminChanged // Event containing the contract specifics and raw log
...
func (it *StakingVSLAdminChangedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakingVSLAdminChanged)
...
func (it *StakingVSLAdminChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakingVSLAdminChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakingVSLAdminChanged represents a AdminChanged event raised by the StakingVSL contract.
type StakingVSLAdminChanged struct {
...
func (_StakingVSL *StakingVSLFilterer) FilterAdminChanged(opts *bind.FilterOpts) (*StakingVSLAdminChangedIterator, error) {

	logs, sub, err := _StakingVSL.contract.FilterLogs(opts, "AdminChanged")
	if err != nil {
		return nil, err
	}
	return &StakingVSLAdminChangedIterator{contract: _StakingVSL.contract, event: "AdminChanged", logs: logs, sub: sub}, nil
}

// WatchAdminChanged is a free log subscription operation binding the contract event 0x7e644d79422f17c01e4894b5f4f588d331ebfa28653d42ae832dc59e38c9798f.
//
// Solidity: event AdminChanged(address previousAdmin, address newAdmin)
func (_StakingVSL *StakingVSLFilterer) WatchAdminChanged(opts *bind.WatchOpts, sink chan<- *StakingVSLAdminChanged) (event.Subscription, error) {

	logs, sub, err := _StakingVSL.contract.WatchLogs(opts, "AdminChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(StakingVSLAdminChanged)
				if err := _StakingVSL.contract.UnpackLog(event, "AdminChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AdminChanged(address previousAdmin, address newAdmin)
func (_StakingVSL *StakingVSLFilterer) ParseAdminChanged(log types.Log) (*StakingVSLAdminChanged, error) {
	event := new(StakingVSLAdminChanged)
	if err := _StakingVSL.contract.UnpackLog(event, "AdminChanged", log); err != nil {
		return nil, err
	}
...
// StakingVSLBeaconUpgradedIterator is returned from FilterBeaconUpgraded and is used to iterate over the raw logs and unpacked data for BeaconUpgraded events raised by the StakingVSL contract.
type StakingVSLBeaconUpgradedIterator struct {
	Event *StakingVSLBeaconUpgraded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StakingVSLBeaconUpgradedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakingVSLBeaconUpgraded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StakingVSLBeaconUpgradedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakingVSLBeaconUpgradedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakingVSLBeaconUpgraded represents a BeaconUpgraded event raised by the StakingVSL contract.
type StakingVSLBeaconUpgraded struct {
...
func (_StakingVSL *StakingVSLFilterer) FilterBeaconUpgraded(opts *bind.FilterOpts, beacon []common.Address) (*StakingVSLBeaconUpgradedIterator, error) {
	...
	logs, sub, err := _StakingVSL.contract.FilterLogs(opts, "BeaconUpgraded", beaconRule)
	if err != nil {
		return nil, err
	}
	return &StakingVSLBeaconUpgradedIterator{contract: _StakingVSL.contract, event: "BeaconUpgraded", logs: logs, sub: sub}, nil
}

// WatchBeaconUpgraded is a free log subscription operation binding the contract event 0x1cf3b03a6cf19fa2baba4df148e9dcabedea7f8a5c07840e207e5c089be95d3e.
//
// Solidity: event BeaconUpgraded(address indexed beacon)
func (_StakingVSL *StakingVSLFilterer) WatchBeaconUpgraded(opts *bind.WatchOpts, sink chan<- *StakingVSLBeaconUpgraded, beacon []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _StakingVSL.contract.WatchLogs(opts, "BeaconUpgraded", beaconRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StakingVSLBeaconUpgraded)
				if err := _StakingVSL.contract.UnpackLog(event, "BeaconUpgraded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BeaconUpgraded(address indexed beacon)
func (_StakingVSL *StakingVSLFilterer) ParseBeaconUpgraded(log types.Log) (*StakingVSLBeaconUpgraded, error) {
	event := new(StakingVSLBeaconUpgraded)
	if err := _StakingVSL.contract.UnpackLog(event, "BeaconUpgraded", log); err != nil {
		return nil, err
	}
...
// StakingVSLUpgradedIterator is returned from FilterUpgraded and is used to iterate over the raw logs and unpacked data for Upgraded events raised by the StakingVSL contract.
type StakingVSLUpgradedIterator struct {
	Event *StakingVSLUpgraded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StakingVSLUpgradedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakingVSLUpgraded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StakingVSLUpgradedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakingVSLUpgradedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakingVSLUpgraded represents a Upgraded event raised by the StakingVSL contract.
type StakingVSLUpgraded struct {
...
func (_StakingVSL *StakingVSLFilterer) FilterUpgraded(opts *bind.FilterOpts, implementation []common.Address) (*StakingVSLUpgradedIterator, error) {
	...
	logs, sub, err := _StakingVSL.contract.FilterLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
	return &StakingVSLUpgradedIterator{contract: _StakingVSL.contract, event: "Upgraded", logs: logs, sub: sub}, nil
}

// WatchUpgraded is a free log subscription operation binding the contract event 0xbc7cd75a20ee27fd9adebab32041f755214dbc6bffa90cc0225b39da2e5c2d3b.
//
// Solidity: event Upgraded(address indexed implementation)
func (_StakingVSL *StakingVSLFilterer) WatchUpgraded(opts *bind.WatchOpts, sink chan<- *StakingVSLUpgraded, implementation []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _StakingVSL.contract.WatchLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StakingVSLUpgraded)
				if err := _StakingVSL.contract.UnpackLog(event, "Upgraded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Upgraded(address indexed implementation)
func (_StakingVSL *StakingVSLFilterer) ParseUpgraded(log types.Log) (*StakingVSLUpgraded, error) {
	event := new(StakingVSLUpgraded)
	if err := _StakingVSL.contract.UnpackLog(event, "Upgraded", log); err != nil {
		return nil, err
	}
