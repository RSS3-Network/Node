...
const _NameName = "unknownfallbackmirrorfarcasterrss3paragraphopenseauniswapoptimismaavegotchilensiqwiki"

var _NameIndex = [...]uint8{0, 7, 15, 21, 30, 34, 43, 50, 57, 65, 75, 79, 85}

const _NameLowerName = "unknownfallbackmirrorfarcasterrss3paragraphopenseauniswapoptimismaavegotchilensiqwiki"
...
var _NameValues = []Name{Unknown, Fallback, Mirror, Farcaster, RSS3, Paragraph, OpenSea, Uniswap, Optimism, Aavegotchi, Lens, IQWiki}
...
var _NameNameToValueMap = map[string]Name{
	...
	_NameName[79:85]:      IQWiki,
	_NameLowerName[79:85]: IQWiki,
}
