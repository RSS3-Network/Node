		...
		},
		{
			...
			arguments: arguments{
				task: &source.Task{
					...
					ChainID: 137,
					Header: &ethereum.Header{
						Hash:         common.HexToHash("0xf23e5b7288ba00223e854538baeadd73c03932c19d95796edf594a03a89da685"),
						ParentHash:   common.HexToHash("0xecb7bec86f1ddf09d477bc3ac5295006a8033570a593c1f2ccc3fc0b5fe9160f"),
						UncleHash:    common.HexToHash("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347"),
						Coinbase:     common.HexToAddress("0xeEDBa2484aAF940f37cd3CD21a5D7C4A7DAfbfC0"),
						Number:       lo.Must(new(big.Int).SetString("44868851", 0)),
						GasLimit:     29650224,
						GasUsed:      2851079,
						Timestamp:    1688902690,
						BaseFee:      lo.Must(new(big.Int).SetString("66558447452", 0)),
						Transactions: nil,
					},
					Transaction: &ethereum.Transaction{
						BlockHash: common.HexToHash("0xb6aa8261aa66f2bc03fcd1df9e9c5d2ca2ee8ffc1cf76eb1d0fda096629aae8c"),
						...
						Hash:      common.HexToHash("0xb6aa8261aa66f2bc03fcd1df9e9c5d2ca2ee8ffc1cf76eb1d0fda096629aae8c"),
						Input:     hexutil.MustDecode(""),
					...
					Receipt: &ethereum.Receipt{
						BlockHash:         common.HexToHash("0xf23e5b7288ba00223e854538baeadd73c03932c19d95796edf594a03a89da685"),
						BlockNumber:       lo.Must(new(big.Int).SetString("44868851", 0)),
						ContractAddress:   nil,
						CumulativeGasUsed: 55638,
						...
						Logs: []*ethereum.Log{{
							...
							Data:            hexutil.MustDecode(""),
							BlockNumber:     lo.Must(new(big.Int).SetString("44868851", 0)),
							TransactionHash: common.HexToHash("0xb6aa8261aa66f2bc03fcd1df9e9c5d2ca2ee8ffc1cf76eb1d0fda096629aae8c"),
							Index:           0,
							Removed:         false,
						}, {
							Address: common.HexToAddress("0x0000000000000000000000000000000000001010"),
							Topics: []common.Hash{
								...
								common.HexToHash("0x000000000000000000000000eedba2484aaf940f37cd3cd21a5d7c4a7dafbfc0"),
							},
							Data:            hexutil.MustDecode(""),
							BlockNumber:     lo.Must(new(big.Int).SetString("44868851", 0)),
							TransactionHash: common.HexToHash("0xb6aa8261aa66f2bc03fcd1df9e9c5d2ca2ee8ffc1cf76eb1d0fda096629aae8c"),
							Index:           1,
							Removed:         false,
			...
			want: &schema.Feed{
				ID:       "0xb6aa8261aa66f2bc03fcd1df9e9c5d2ca2ee8ffc1cf76eb1d0fda096629aae8c",
				Network:  filter.NetworkPolygon,
				Index:    0,
				...
				Platform: lo.ToPtr(filter.PlatformLens),
				Fee: &schema.Fee{
					Amount:  lo.Must(decimal.NewFromString("18598336047533880")),
					Decimal: 18,
				},
				Actions: []*schema.Action{
					{
						...
						Metadata: metadata.SocialProfile{
							...
							Handle:    "leiniercs.lens",
							Name:      "Leinier",
							Bio:       "Software developer: C++, Javascript, Solidity. Web3 «-» Freedom",
						},
					},
				},
				Status:    true,
