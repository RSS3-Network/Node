...
import (
	...
	"github.com/rss3-network/node/v2/provider/ethereum/contract/looksrare"
...
func (w *worker) Name() string {
	return decentralized.Looksrare.String()
}

func (w *worker) Platform() string {
	return decentralized.PlatformLooksRare.String()
}
