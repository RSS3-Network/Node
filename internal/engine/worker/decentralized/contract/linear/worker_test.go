...
func TestWorker_Near(t *testing.T) {
	...
	testcases := []struct {
		...
		//						Value:   lo.ToPtr(lo.Must(decimal.NewFromString("3191805000000000000000"))),
		//					},
		//					To: metadata.Token{
		//						Address: lo.ToPtr("wrap.near"),
		...
		//					},
		//					To: metadata.Token{
		//						Address: lo.ToPtr("usdt.tether-token.near"),
		//						Value:   lo.ToPtr(decimal.Zero),
		//					},
		//				},
		//			},
		...
		//						Value:   lo.ToPtr(lo.Must(decimal.NewFromString("25020235"))),
		//					},
		//				},
		//			},
		//			{
		...
		//					From: metadata.Token{
		//						Address: lo.ToPtr("802d89b6e511b335f05024a65161bce7efc3f311.factory.bridge.near"),
		//						Value:   lo.ToPtr(lo.Must(decimal.NewFromString("1063935000000000000000"))),
		//					},
		//					To: metadata.Token{
		//						Address: lo.ToPtr("wrap.near"),
		//						Value:   lo.ToPtr(decimal.Zero),
		...
		//					To: metadata.Token{
		//						Address: lo.ToPtr("a0b86991c6218b36c1d19d4a2e9eb0ce3606eb48.factory.bridge.near"),
		//						Value:   lo.ToPtr(lo.Must(decimal.NewFromString("8283016"))),
		//					},
		//				},
		//			},
		//		},
