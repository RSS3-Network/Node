...
import (
	...
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell"
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell/character"
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell/event"
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell/periphery"
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell/profile"
	"github.com/rss3-network/node/v2/provider/ethereum/contract/crossbell/tips"
...
func (w *worker) Name() string {
	return decentralized.Crossbell.String()
}

func (w *worker) Platform() string {
	return decentralized.PlatformCrossbell.String()
}
