...
func (fc *FeedCreate) check() error {
	if _, ok := fc.mutation.Chain(); !ok {
		return &ValidationError{Name: "chain", err: errors.New(`internal: missing required field "Feed.chain"`)}
	}
	...
	if _, ok := fc.mutation.Platform(); !ok {
		return &ValidationError{Name: "platform", err: errors.New(`internal: missing required field "Feed.platform"`)}
	}
	if _, ok := fc.mutation.From(); !ok {
		return &ValidationError{Name: "from", err: errors.New(`internal: missing required field "Feed.from"`)}
	}
	...
	if _, ok := fc.mutation.To(); !ok {
		return &ValidationError{Name: "to", err: errors.New(`internal: missing required field "Feed.to"`)}
	}
	...
	if _, ok := fc.mutation.Tag(); !ok {
		return &ValidationError{Name: "tag", err: errors.New(`internal: missing required field "Feed.tag"`)}
	}
	...
	if _, ok := fc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`internal: missing required field "Feed.type"`)}
	}
	...
	if _, ok := fc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`internal: missing required field "Feed.status"`)}
	}
	...
	if _, ok := fc.mutation.Index(); !ok {
		return &ValidationError{Name: "index", err: errors.New(`internal: missing required field "Feed.index"`)}
	}
	if _, ok := fc.mutation.TotalActions(); !ok {
		return &ValidationError{Name: "total_actions", err: errors.New(`internal: missing required field "Feed.total_actions"`)}
	}
	if _, ok := fc.mutation.Actions(); !ok {
		return &ValidationError{Name: "actions", err: errors.New(`internal: missing required field "Feed.actions"`)}
	}
	if _, ok := fc.mutation.FeeValue(); !ok {
		return &ValidationError{Name: "fee_value", err: errors.New(`internal: missing required field "Feed.fee_value"`)}
	}
	if _, ok := fc.mutation.FeeToken(); !ok {
		return &ValidationError{Name: "fee_token", err: errors.New(`internal: missing required field "Feed.fee_token"`)}
	}
	if _, ok := fc.mutation.Timestamp(); !ok {
		return &ValidationError{Name: "timestamp", err: errors.New(`internal: missing required field "Feed.timestamp"`)}
	}
	if _, ok := fc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`internal: missing required field "Feed.created_at"`)}
	}
	if _, ok := fc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`internal: missing required field "Feed.updated_at"`)}
	}
	if v, ok := fc.mutation.ID(); ok {
		if err := feed.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`internal: validator failed for field "Feed.id": %w`, err)}
		}
	}
	return nil
}
