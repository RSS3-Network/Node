...
var (
	...
	FeedsColumns = []*schema.Column{
		...
		{Name: "index", Type: field.TypeUint, Default: 0},
		{Name: "total_actions", Type: field.TypeUint, Default: 0},
		{Name: "actions", Type: field.TypeJSON},
		{Name: "fee_value", Type: field.TypeOther, SchemaType: map[string]string{"mysql": "bigint", "postgres": "bigint"}},
