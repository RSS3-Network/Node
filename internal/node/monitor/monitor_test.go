	...
	testcases := []struct {
		...
		// Ethereum Worker
		{
			...
			arguments: arguments{
				...
				latestState:   19800000 + parameter.CurrentNetworkTolerance[network.Ethereum.String()] + 1,
		...
		// Arweave Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1420000 + parameter.CurrentNetworkTolerance[network.Arweave.String()] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusIndexing,
			wantError: require.NoError,
...

		{
			...
			arguments: arguments{
				...
				latestState:   1637596118633 + parameter.CurrentNetworkTolerance[network.Arweave.String()]*120000 + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusIndexing,
			wantError: require.NoError,
		...
		// Farcaster Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1714972833273 + parameter.CurrentNetworkTolerance[network.Farcaster.String()] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusIndexing,
			wantError: require.NoError,
