	...
	testcases := []struct {
		...
		// Ethereum Worker
		{
			...
			arguments: arguments{
				...
				latestState:   19800000 + config.NetworkTolerance[network.Ethereum] + 1,
		...
		// Arweave Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1420000 + config.NetworkTolerance[network.Arweave] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusIndexing,
			wantError: require.NoError,
		...
		// Farcaster Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1714972833273 + config.NetworkTolerance[network.Farcaster] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusIndexing,
			wantError: require.NoError,
