	...
	testcases := []struct {
		...
		// Ethereum Worker
		{
			...
			arguments: arguments{
				...
				latestState:   19800000 + monitor.NetworkTorlerance[network.Ethereum] + 1,
		...
		// Arweave Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1420000 + monitor.NetworkTorlerance[network.Arweave] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusUnhealthy,
			wantError: require.NoError,
		...
		// Farcaster Worker
		{
			...
			arguments: arguments{
				...
				latestState:   1714972833273 + monitor.NetworkTorlerance[network.Farcaster] + 1,
				initialStatus: worker.StatusReady,
			},
			want:      worker.StatusUnhealthy,
			wantError: require.NoError,
