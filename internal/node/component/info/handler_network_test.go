	...
	tests := []struct {
		...
		},
		{
			...
			expected: MinimumResource{
				CPUCore:       2.0,
				MemoryInGb:    2.0,
				DiskSpaceInGb: parameter.CurrentNetworkCoreWorkerDiskSpacePerMonth[network.Polygon.String()] * parameter.NumberOfMonthsToCover,
			},
		},
		...
		// High-demand-workers + low-demand-networks
		{
			...
			expected: MinimumResource{
				CPUCore:       1.0,
				MemoryInGb:    1.0,
				DiskSpaceInGb: parameter.CurrentNetworkCoreWorkerDiskSpacePerMonth[network.Linea.String()] * parameter.NumberOfMonthsToCover,
			},
		},
