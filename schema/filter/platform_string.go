...
const _PlatformName = "PlatformRSS3PlatformUniswap"

var _PlatformIndex = [...]uint8{0, 12, 27}

const _PlatformLowerName = "platformrss3platformuniswap"
...
func _PlatformNoOp() {
	var x [1]struct{}
	_ = x[PlatformRSS3-(1)]
	_ = x[PlatformUniswap-(2)]
}

var _PlatformValues = []Platform{PlatformRSS3, PlatformUniswap}

var _PlatformNameToValueMap = map[string]Platform{
	_PlatformName[0:12]:       PlatformRSS3,
	_PlatformLowerName[0:12]:  PlatformRSS3,
	_PlatformName[12:27]:      PlatformUniswap,
	_PlatformLowerName[12:27]: PlatformUniswap,
}
