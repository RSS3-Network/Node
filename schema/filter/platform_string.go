...
const _PlatformName = "RSS3MirrorFarcasterParagraphOpenSeaOptimism"

var _PlatformIndex = [...]uint8{0, 4, 10, 19, 28, 35, 43}

const _PlatformLowerName = "rss3mirrorfarcasterparagraphopenseaoptimism"
...
func _PlatformNoOp() {
	...
	_ = x[PlatformOptimism-(6)]
}

var _PlatformValues = []Platform{PlatformRSS3, PlatformMirror, PlatformFarcaster, PlatformParagraph, PlatformOpenSea, PlatformOptimism}
...
var _PlatformNameToValueMap = map[string]Platform{
	...
	_PlatformName[35:43]:      PlatformOptimism,
	_PlatformLowerName[35:43]: PlatformOptimism,
}
