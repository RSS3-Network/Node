...
const _PlatformName = "RSS3MirrorFarcasterParagraphOpenSeaAavegotchi"

var _PlatformIndex = [...]uint8{0, 4, 10, 19, 28, 35, 45}

const _PlatformLowerName = "rss3mirrorfarcasterparagraphopenseaaavegotchi"
...
func _PlatformNoOp() {
	...
	_ = x[PlatformAavegotchi-(6)]
}

var _PlatformValues = []Platform{PlatformRSS3, PlatformMirror, PlatformFarcaster, PlatformParagraph, PlatformOpenSea, PlatformAavegotchi}
...
var _PlatformNameToValueMap = map[string]Platform{
	...
	_PlatformName[35:45]:      PlatformAavegotchi,
	_PlatformLowerName[35:45]: PlatformAavegotchi,
}
