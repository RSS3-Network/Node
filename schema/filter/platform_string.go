...
const _PlatformName = "RSS3MirrorFarcasterParagraphOpenSeaUniswapOptimismAavegotchiLensLooksRareMattersCrossbell"

var _PlatformIndex = [...]uint8{0, 4, 10, 19, 28, 35, 42, 50, 60, 64, 73, 80, 89}

const _PlatformLowerName = "rss3mirrorfarcasterparagraphopenseauniswapoptimismaavegotchilenslooksrarematterscrossbell"
...
func _PlatformNoOp() {
	...
	_ = x[PlatformCrossbell-(12)]
}

var _PlatformValues = []Platform{PlatformRSS3, PlatformMirror, PlatformFarcaster, PlatformParagraph, PlatformOpenSea, PlatformUniswap, PlatformOptimism, PlatformAavegotchi, PlatformLens, PlatformLooksRare, PlatformMatters, PlatformCrossbell}
...
var _PlatformNameToValueMap = map[string]Platform{
	...
	_PlatformName[80:89]:      PlatformCrossbell,
	_PlatformLowerName[80:89]: PlatformCrossbell,
}
