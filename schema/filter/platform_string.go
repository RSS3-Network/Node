...
const _PlatformName = "RSS3MirrorFarcasterParagraphOpenSeaUniswapOptimismAavegotchiLensLooksRareCrossbell"

var _PlatformIndex = [...]uint8{0, 4, 10, 19, 28, 35, 42, 50, 60, 64, 73, 82}

const _PlatformLowerName = "rss3mirrorfarcasterparagraphopenseauniswapoptimismaavegotchilenslooksrarecrossbell"
...
func _PlatformNoOp() {
	...
	_ = x[PlatformCrossbell-(11)]
}

var _PlatformValues = []Platform{PlatformRSS3, PlatformMirror, PlatformFarcaster, PlatformParagraph, PlatformOpenSea, PlatformUniswap, PlatformOptimism, PlatformAavegotchi, PlatformLens, PlatformLooksRare, PlatformCrossbell}
...
var _PlatformNameToValueMap = map[string]Platform{
	...
	_PlatformName[73:82]:      PlatformCrossbell,
	_PlatformLowerName[73:82]: PlatformCrossbell,
}
