...
const _TransactionTypeName = "transfer"

var _TransactionTypeIndex = [...]uint8{0, 8}

const _TransactionTypeLowerName = "transfer"
...
var _TransactionTypeValues = []TransactionType{TypeTransactionTransfer}
