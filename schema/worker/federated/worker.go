...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.6 --type=Worker --linecomment --output ../../../docs/schemas/worker/Federated.yaml -t ../../../docs/schemas/tmpl/Federated.yaml.tmpl
type Worker int
