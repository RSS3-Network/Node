...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=Platform --linecomment --output ../../../docs/schemas/platform/Federated.yaml -t ../../../docs/schemas/tmpl/Federated.yaml.tmpl
