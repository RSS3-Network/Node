...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=Platform --linecomment --output ../../../docs/schemas/platform/Decentralized.yaml -t ../../../docs/schemas/tmpl/Decentralized.yaml.tmpl
