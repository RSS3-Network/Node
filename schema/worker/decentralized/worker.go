...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=Worker --linecomment --output ../../../docs/schemas/worker/Decentralized.yaml -t ../../../docs/schemas/tmpl/Decentralized.yaml.tmpl
type Worker int
